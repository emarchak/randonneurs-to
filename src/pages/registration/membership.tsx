        ...
        < Layout >
            ...
            <ContentWrapper container>
                <ContentChild>
                    ...
                    <LinkButton href="https://ccnbikes.com/#!/events/randonneurs-ontario-membership-2023" secondary small block>Join as a trial</LinkButton>
                </ContentChild>
                <ContentChild>
                    ...
                    <LinkButton href="https://ccnbikes.com/#!/events/randonneurs-ontario-membership-2023" primary small block>Join as an individual</LinkButton>
                </ContentChild>
                <ContentChild>
                    ...
                    <LinkButton href="https://ccnbikes.com/#!/events/randonneurs-ontario-membership-2023" secondary small block>Join as a family</LinkButton>
                </ContentChild>
            </ContentWrapper>
        </Layout >
    )
